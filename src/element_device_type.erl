...
render_element(#element_dt{  	
					
							}) -> 
	Browsers = n_user_map_proc:get_browser_os(),
	...
	Element = [
		...
		#panel{class = "box-header with-border",
			   body = 
				   [
					#h3{class = "box-title", text = "Device"},
                  ...
                  <div class=\"row\">
                    <div class=\"col-md-8\">
                      <div class=\"chart-responsive\">
                        <canvas id=\"pieChart3\" height=\"160\" width=\"329\" style=\"width: 329px; height: 160px;\"></canvas>
